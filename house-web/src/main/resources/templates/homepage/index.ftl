        ...
        <section id="new-properties" class="block">
            <div class="container">
                <header class="section-title">
                    <strong><h2>新上房源</h2></strong>
                    <a href="/house/list" class="link-arrow"><strong>所有房源</strong></a>
                </header>
                <div class="row">
...
<#--        </section><!-- /#testimonials &ndash;&gt;-->
        <section id="partners" class="block">
            <div class="container">
                ...
                <div class="logos">
                    <div class="logo"><img src="/static/assets/img/logo-partner-01.png" alt=""></div>
                    <div class="logo"><img src="/static/assets/img/logo-partner-02.png" alt=""></div>
                    <div class="logo"><img src="/static/assets/img/logo-partner-03.png" alt=""></div>
                    <div class="logo"><img src="/static/assets/img/logo-partner-04.png" alt=""></div>
                    <div class="logo"><img src="/static/assets/img/logo-partner-05.png" alt=""></div>
                </div>
            </div><!-- /.container -->
        </section><!-- /#partners -->
    </div>
