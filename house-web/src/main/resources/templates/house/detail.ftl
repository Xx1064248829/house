                                    ...
                                    <div class="floor-plans">
                                        ...
                                        <#list house.floorPlanList as floorPlan>
                                            <a href="${floorPlan}" class="image-popup"><img alt=""
                                                                                            src="${floorPlan}"></a>
                                        <#--                                             <a href="${floorPlan}" class="image-popup"><img alt="" src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1577953405&di=bab1680e48f7dd6be11b41059f16caa9&imgtype=jpg&er=1&src=http%3A%2F%2Fcache.qztvxwgj.com%2Fupload%2Fueditor%2Fimage%2F20180419%2F1524130185860154.jpg"></a>-->
                                        </#list>
                                    </div>
                                </section><!-- /#floor-plans -->
